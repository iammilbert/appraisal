			...
			<form class="form">
                ...
                <?php endif ?>
		 		...
		 		<table class="table" style="font-size: 13px">
		 			...
		 			$sql="SELECT lecturers_data.id, lecturers_data.firstName, lecturers_data.lastName, lecturers_data.middleName, lecturers_data.staff_id, faculties.faculties, departments.departments, lecturers_data.gender, lecturers_data.mobile, lecturers_data.email, lecturers_data.title 
