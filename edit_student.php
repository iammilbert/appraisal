...
$sql = "UPDATE student_signup SET firstName = '".$firstName."', lastName = '".$lastName."', middleName = '".$middleName."', gender = '".$gender."', school_id = '".$school_id."', faculty_id = '".$faculty_id."', department_id = '".$department_id."', course_id = '".$course_id."', matric_Number = '".$matric_Number."', email = '".$email."', mobile = '".$mobile."'  WHERE id = '".$id."'";
				...
				<fieldset">
					...
					<?php 
						...
						?>
								...
								<option value="<?php echo $row2['school_id']; ?>"><?php echo $row2['schoolNames']; ?></option>
							<?php endwhile; ?>
							</select>
					</div>
					...
					<?php 
						...
						?>
								...
								<option value="<?php echo $row['faculty_id']; ?>"><?php echo $row3['faculties']; ?></option>
							<?php endwhile; ?>
							</select>
					</div>
					...
					<?php 
						...
						?>
								...
								<option value="<?php echo $row['department_id']; ?>"><?php echo $row4['departments']; ?></option>
							<?php endwhile; ?>
							</select>
					</div>
					...
					<?php 
						...
						?>
								...
								<option value="<?php echo $row['course_id']; ?>"><?php echo $row5['courses']; ?></option>
							<?php endwhile; ?>
							</select>
					</div>
