...
if (isset($_GET['delete'])) {
	$id = $_GET['delete'];
		...
		$sql = "SELECT student_signup.id, student_signup.firstName, student_signup.lastName, student_signup.middleName, student_signup.matric_Number, faculties.faculties, departments.departments, schools.schoolNames, student_signup.gender, student_signup.mobile, student_signup.email, courses.courses, student_signup.password FROM student_signup
