...
if (isset($_POST['confirm'])) {
			...
			$email = $_POST['email'];
			$check_duplicate_email = "SELECT email FROM lecturers_data WHERE email = '".$email."'";
...
if (count($errors)==0) {
			$sql = "INSERT INTO lecturers_data(title, firstName, lastName, middleName, gender, school_id, faculty_id, department_id, email, staff_id, mobile, password) VALUES('".$title."', '".$firstName."', '".$lastName."', '".$middleName."', '".$gender."', '".$school_id."', '".$faculty_id."', '".$department_id."', '".$email."', '".$staff_id."', '".$mobile."', '".$password."')";
