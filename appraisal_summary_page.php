		...
		<div class="container-fluid" >
			<div class="col-md-3" style="padding-bottom: 200px; padding-top: 40px;">
				<form method="POST">
					...
					<div class="form-group">
						<input type="submit" name="view" value="View" class="btn btn-light btn-radius grd1 btn-block btn-brd">
					</div>
				</form>
			</div>
			...
			if (isset($_POST['view'])) {
				...
				$department_id = $_POST['department_id'];
		 		...
		 		$sql = "SELECT lecturers_data.id, lecturers_data.staff_id, lecturers_data.firstName, lecturers_data.lastName, lecturers_data.middleName, lecturers_data.title, lecturers_data.email, faculties.faculties, departments.departments  FROM lecturers_data 
			    		INNER JOIN schools
			    		...
			    		WHERE lecturers_data.school_id = '".$row2['school_id']."' AND lecturers_data.department_id = '".$department_id."' AND lecturers_data.faculty_id = '".$faculty_id."'";
